...
class Alu:
    ...
    def __alu_eq(self):
        return self.ALU_BRANCH_TO_ASM_COMMAND.format(branch=BRANCH_EQ, index=self.label_index)

    def __alu_gt(self):
        return self.ALU_BRANCH_TO_ASM_COMMAND.format(branch=BRANCH_GT, index=self.label_index)

    def __alu_lt(self):
        return self.ALU_BRANCH_TO_ASM_COMMAND.format(branch=BRANCH_LT, index=self.label_index)
